...
class FollowerList extends React.Component {
    ...
    componentDidMount(){
        axios.get('https://api.github.com/users/Kirisaro/followers')
          .then(response => {
              this.setState({
                ...this.state,
    ...
    handleSubmit = (event) => {
        ...
        axios.get(`https://api.github.com/users/Kirisaro/${this.state.followers}`)
          .then(resp => {
            this.setState({
              ...this.state,
        ...
        <div>
            <div>
              <form >
                ...
                <button onClick={this.handleSubmit} >Search Followers</button>
              </form>
            </div>
            <div>
                {
